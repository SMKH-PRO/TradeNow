...
presenceRef.onDisconnect().set({ParentID:firebase.auth().currentUser.uid+"ParentStatus",UserID:firebase.auth().currentUser.uid+"Status",Name:firebase.auth().currentUser.displayName,Photo:firebase.auth().currentUser.photoURL,status:"Offline"});
