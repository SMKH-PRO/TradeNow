                ...
                var emailofuser =    data.child("Email").val()
                 ...
                 var fullnameofuser=   data.child("FirstName").val()
                  ...
                  var nickofuser = data.child("Name").val()
                   ...
                   var userdetails = {ID:firebase.auth().currentUser.uid,Name:fullnameofuser,Reason:"AutoBlock Systems",BlockedByAdmin:"server@autoblock",Pic:ProfilePicOfUser,Email:emailofuser,FBLink:fblinkofuser,NickName:nickofuser,Phone:phoneofuser,LArea:lastloginarea, LIP:lastipofuser,LISP:lastispofuser,RArea:regareaofuser,RIP:regipofuser,RISP:regispofuser};
