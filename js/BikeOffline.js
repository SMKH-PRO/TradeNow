...
if(data.hasChild(key) === false){
    ...
    iterationOfFunctionBike =iterationNumber;
    ...
    //    console.log(iterationOfFunctionBike+"/"+numberOfKeys)
    //console.log("TotalNumber Of AllAds Saved Images"+numberOfKeys)
                if(iterationOfFunctionBike >= numberOfKeys){
        ...
        else{//console.log(iterationOfFunctionBike+"/"+numberOfKeys);
    }
        //}
    }).then(function() {
