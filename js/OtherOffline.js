    ...
    var iterationOfFunctionOther = 0;
    var isUserOnline = "NO"
    ...
    console.log("Removed: ",data.key)
     ...
     SavedAds.removeItem(data.key).then(function() {
        ...
        ///Now Saving Data In local storage to count Offline Ads that maybe available
...
if(data.hasChild(key) === false){
    ...
    iterationOfFunctionOther =iterationNumber;
    ...
    //    console.log(iterationOfFunctionOther+"/"+numberOfKeys)
    //console.log("TotalNumber Of AllAds Saved Images"+numberOfKeys)
                if(iterationOfFunctionOther >= numberOfKeys){
        ...
        else{//console.log(iterationOfFunctionOther+"/"+numberOfKeys);
    }
        //}
    }).then(function() {
