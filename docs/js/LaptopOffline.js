    ...
    var iterationOfFunctionLaptop = 0;
    var isUserOnline = "NO"
...
if(data.hasChild(key) === false){
    ...
    iterationOfFunctionLaptop =iterationNumber;
    ...
    //    console.log(iterationOfFunctionLaptop+"/"+numberOfKeys)
    //console.log("TotalNumber Of AllAds Saved Images"+numberOfKeys)
                if(iterationOfFunctionLaptop >= numberOfKeys){
        ...
        else{//console.log(iterationOfFunctionLaptop+"/"+numberOfKeys);
    }
        //}
    }).then(function() {
