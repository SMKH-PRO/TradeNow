    ...
    var iterationOfFunctionMobile = 0;
    var isUserOnline = "NO"
...
if(data.hasChild(key) === false){
    ...
    iterationOfFunctionMobile =iterationNumber;
    ...
    //    console.log(iterationOfFunctionMobile+"/"+numberOfKeys)
    //console.log("TotalNumber Of AllAds Saved Images"+numberOfKeys)
                if(iterationOfFunctionMobile >= numberOfKeys){
        ...
        else{//console.log(iterationOfFunctionMobile+"/"+numberOfKeys);
    }
        //}
    }).then(function() {
